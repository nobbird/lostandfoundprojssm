    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">失物启事纵览</div>
        ...
        table.on('tool(test-table-operate)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    obj.del();
                    url:'${pageContext.request.contextPath}/wupingController/deleteWuping/{data.id}'
                    layer.close(index);
                });
                ...
                layer.open({
                    type:2
                    ,title:'启事详细信息'
                    ,content:'/lostWupingForm'
                    ,maxmin:true
                    ,area:['500px', '450px']
                    ,success:function (layero,index) {
                        var othis=layero.find('iframe').contents().find('#layuiadmin-lostform-useradmin').click();
                        ...
                        othis.find('input[name="status"]').val( data.state==='0'?'未找到':'已找到');
                    }
                })
            }
        });
