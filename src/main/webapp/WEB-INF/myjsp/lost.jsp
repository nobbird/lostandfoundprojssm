...
<div class="am-g am-container newatype">
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-8 oh">
        <div data-am-widget="titlebar" class="am-titlebar am-titlebar-default"
            ...
            <h2 class="am-titlebar-title ">失物启事 </h2>
...
<script>
    ...
    layui.use(['laypage', 'laytpl'], function () {
        $.post('/wupingController/getWupingByPages/0', {pageNow: 1, pageSize: 8}, function (data) {
            ...
            laypage.render({
                ...
                limit: 8,
                jump: function (obj) {
                    $.post('/wupingController/getWupingByPages/0', {pageNow: obj.curr, pageSize: 8}, function (data) {
                        flash(data.payload);
                    });
                }
            })
